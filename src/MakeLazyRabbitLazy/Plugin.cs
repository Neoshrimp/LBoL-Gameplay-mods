...
namespace MakeLazyRabbitLazy
{
    ...
    public class Plugin : BaseUnityPlugin
    {
        ...
        class LazyRabbit_Patch
        {
            ...
            static Dictionary<GameDifficulty, RepeatableRandomPool<bool>> beLazyDifficulty2Pool = new Dictionary<GameDifficulty, RepeatableRandomPool<bool>>()
            {
            ...
            static void UpdateMoveCounters_Postfix(LazyRabbit __instance)
            {
                if (wt_lastMove.TryGetValue(__instance, out LastMove lastMove))
                {
                    ...
                    {
                        if (beLazyDifficulty2Pool[GameMaster.Instance.CurrentGameRun.Difficulty].Sample(__instance.EnemyMoveRng))
                        {
